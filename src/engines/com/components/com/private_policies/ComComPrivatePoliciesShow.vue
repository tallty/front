...
const ComComPrivatePoliciesShow = defineComponent({
  name: 'ComComPrivatePoliciesShow',
  components: {},
  props: {
...
export default ComComPrivatePoliciesShow;
</script>

<template lang="pug">
.com-com-admin-private-policies-show
  TaShowLayout(
    :tabs='tabs',
    :title='record.name',
    :store='store',
