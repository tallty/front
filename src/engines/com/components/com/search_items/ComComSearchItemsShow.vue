...
const ComComSearchItemsShow = defineComponent({
  name: 'ComComSearchItemsShow',
  components: {},
  props: {
...
export default ComComSearchItemsShow;
</script>

<template lang="pug">
.com-com-admin-search-items-show
  TaShowLayout(
    :tabs='tabs',
    :title='record.name',
    :store='store',
